//
//  PartialAutoLayoutTableViewController.m
...
#import "ConstantAutoLayoutTableViewController.h"
#import "TwitterTimelineManager.h"
#import "ConstantAutoLayoutCell.h"
@implementation ConstantAutoLayoutTableViewController {
    NSArray *_statuses;
...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[ConstantAutoLayoutCell nib] forCellReuseIdentifier:[ConstantAutoLayoutCell reuseIdentifier]];
...
{
    ConstantAutoLayoutCell *cell = [tableView dequeueReusableCellWithIdentifier:[ConstantAutoLayoutCell reuseIdentifier] forIndexPath:indexPath];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Status *status = _statuses[indexPath.row];
    CGFloat height = [ConstantAutoLayoutCell heightForStatus:status forWidth:self.view.bounds.size.width];
